...
def main(writer, name, batch_size=256):
    ...
    dataset_test_dmp = DMPDatasetEERandTarXYLang([os.path.join(data_root_path, 'dataset/mujoco_dataset_pick_push_RGBD_different_angles_fast_gripper_224_test/')], random=False, length_total=120, normalize='separate')
...
if __name__ == '__main__':
    name = 'train-baseline-bcz-film-resnet-huberloss-jaco2-to-ur5'
