...
from utils.load_data_rgb_abs_action_fast_gripper_finetuned_attn_dalle_1_obj_fov40 import DMPDatasetEERandTarXYLang, pad_collate_xy_lang
...
if __name__ == '__main__':
    name = 'train-baseline-bcz-film-resnet-huberloss-dalle-1-obj-fov40'
